  ...
  return (
    <div className="glass-panel rounded-3xl p-5 shadow-[0_20px_40px_rgba(0,0,0,0.45)]">
      <div className="flex items-center justify-between">
        ...
        <span className="rounded-[8px] bg-primary/15 border border-primary/40 px-2 py-0.5 font-mono text-[9px] font-bold uppercase tracking-wider text-primary">
          {rank.name}
        </span>
      </div>
      ...
      <div className="mt-2 flex items-baseline gap-1.5">
        ...
        <span className="font-mono text-xs font-semibold text-primary">RC</span>
      </div>
      ...
      <div className="mt-3.5">
        ...
        <div className="h-2 w-full overflow-hidden rounded-full bg-[#161616] p-0.5 border border-white/[0.06]">
          <div
            className="h-full rounded-full bg-primary shadow-[0_0_12px_var(--glow-color,rgba(204,255,0,0.6))] transition-all duration-500"
      ...
      <p className="mt-3 text-[12px] leading-relaxed text-[#b8b8b8]">
        {rank.next ? (
          <>
            <span className="font-semibold text-primary">{rank.toNext} RC</span> needed to reach{" "}
